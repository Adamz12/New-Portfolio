        ...
        >
          <p className="theme--detail--dark">
            <ScrambleText delay={2}>
              I am a aspiring front-end developer with a strong desire to embark
              on my journey in the world of software engineering. My goal is to
              contribute my skills and enthusiasm to a dynamic team and take on
              exciting challenges in the field of web development. Continuously
              working towards improving my knowledge and skills to develop
              technologies that contribute to the betterment of society.
            </ScrambleText>
          </p>
        </motion.div>
